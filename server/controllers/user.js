...
const register = async (req, res, next)=>{
    try {
        const { name, username, email, password, picturePath, friends, location, occupation, } = req.body;
        if (!(name && username && email && password && picturePath && friends && location && occupation)) {
